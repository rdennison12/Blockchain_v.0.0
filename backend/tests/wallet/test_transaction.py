...
def test_transaction_update():
    ...
    # Below tests the next_recipient and sender_wallet balance after the update
    ...
    # Below will test adding to the first_recipient after the update
...
def rest_invalid_reward_transaction_extra_recipient():
    reward_transaction = Transaction.reward_transaction(Wallet())
